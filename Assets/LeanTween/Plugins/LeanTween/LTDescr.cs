...
break;
    ...
    /// </summary>
    /// <param name="overshoot">how far past the destination it will go before settling in</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="period">how short the iterations are that the tween will animate at (default 0.3f)</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="scale">how much the ease will be multiplied by (default 1f)</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="easeDefinition">an <a href="http://docs.unity3d.com/Documentation/ScriptReference/AnimationCurve.html" target="_blank">AnimationCure</a> that describes the type of easing you want, this is great for when you want a unique type of movement</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="to">point at which you want the tween to reach</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="finishTime">the length of time in seconds you wish the tween to complete in</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// Set the finish time of the tween
    /// </summary>
    /// <param name="speed">the speed in unity units per second you wish the object to travel (overrides the given time)</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="repeatNum">the number of times to repeat the tween. -1 to repeat infinite times</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="useUnScaledTime">whether to use the unscaled time or not</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="useFrames">whether to use estimated time or not</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="loops">(defaults to -1) how many times you want the loop to happen (-1 for an infinite number of times)</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="loops">(defaults to -1) how many times you want the loop to happen in both directions (-1 for an infinite number of times). Passing a value of 1 will cause the object to go towards and back from it's destination once.</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onComplete">the method that should be called when the tween is finished ex: tweenFinished(){ }</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// Have a method called when the tween finishes
    /// </summary>
    /// <param name="onComplete">the method that should be called when the tween is finished ex: tweenFinished( object myObj ){ }</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onComplete">an object that</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onUpdate">a method that will be called on every frame with the float value of the tweened object</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onUpdate">a method that will be called on every frame with the float value of the tweened object, and an object of the person's choosing</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onUpdateParam">an object that will be passed along with the onUpdate method</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="doesOrient">whether the gameobject will orient to the path it is animating along</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="point">point at which you want the object to rotate around (local space)</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="isOn">does call onComplete on every loop cycle</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="isOn">does call onComplete at the start of the tween</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="onStart">the method that should be called when the tween is starting ex: tweenStarted( ){ }</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="direction">the direction that the tween should run, -1f for backwards 1f for forwards</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
    ...
    /// </summary>
    /// <param name="useRecursion">whether the tween will recursively effect an objects children in the hierarchy</param>
    /// <returns>LTDescr an object that distinguishes the tween</returns>
